...
class PresidioStreamingPIIGuardrail:
    ...
    def __init__(self, buffer_size: int =100, safety_margin: int = 20):
        ...
        # 2. Create NlpEngineProvider with configurations
...
def main():
    ...
    # 3. Create console chat with LLM, preserve history and filter streaming chunks
    print("Chat started with streaming PII guardrail!")
    print("Type 'exit' or 'quit' to end the conversation.\n")
    print("Note: All streamed responses will be filtered for PII in real-time.\n")
        ...
        try:
            ...
            for chunk in llm.stream(messages):
                ...
                if chunk_content:
                    ...
                    safe_chunk = guardrail.process_chunk(chunk_content)
                    
                    # Print safe content immediately
                    if safe_chunk:
            ...
            # Add the full filtered response to history
            if full_response:
